...
static const int core_millivolts[MAX_DVFS_FREQS] =
	{950, 1000, 1100, 1200, 1225, 1275, 1325, 1400, 1450};
...
static struct dvfs dvfs_init[] = {
	...
	/* Core voltages (mV):         950,   1000,   1100,   1200,   1225,   1275,   1325,   1400,   1450 */
	...
	CORE_DVFS("mpe",     1, KHZ, 104500, 152000, 228000, 250000, 250000, 250000, 300000, 300000, 300000),
	CORE_DVFS("vi",      1, KHZ, 85000,  100000, 150000, 150000, 150000, 150000, 150000, 150000, 150000),
	CORE_DVFS("sclk",    1, KHZ, 95000,  133000, 190000, 240000, 240000, 240000, 300000, 300000, 300000),
	CORE_DVFS("vde",     1, KHZ, 95000,  123500, 209000, 240000, 240000, 240000, 300000, 300000, 300000),
	/* What is this? */
